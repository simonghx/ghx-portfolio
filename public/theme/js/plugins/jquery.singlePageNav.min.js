...
if (typeof Object.create !== "function") {
    ...
    var i = {
        ...
        setTimer: function() {
            var e = this;
            e.$window.on("scroll.singlePageNav", function() { e.didScroll = true });
        ...
        getCoords: function(e) { return { top: Math.round(e.offset().top) - this.options.offset } },
        ...
        getCurrentSection: function(t) { var n, r, i, s; for (n = 0; n < this.$links.length; n++) { r = this.$links[n].hash; if (e(r).length) { i = this.getCoords(e(r)); if (t >= i.top - this.options.threshold) { s = r } } } return s || this.$links[0].hash }
    };
