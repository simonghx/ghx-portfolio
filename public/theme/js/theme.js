$(function() {
    ...
    function n() {
        ...
        a = e.hasClass("masonry") ? "masonry" : "fitRows", e.isotope({ itemSelector: ".portfolio-item", layoutMode: a, animationOptions: { duration: 750, easing: "linear", queue: !1 } }), $(".portfolio-filter").on("click", ".categories", function() {
            var a = $(this).attr("data-filter");
            e.isotope({ filter: a })
        }), $(".categories-filter").each(function(a, e) {
            var i = $(e);
            i.on("click", ".categories", function() { i.find(".active").removeClass("active"), $(this).addClass("active") })
        })
    }
    ...
    function r() { $(".gallery-popup").magnificPopup({ delegate: ".gallery-popup-link", type: "image", tLoading: "Loading image #%curr%...", mainClass: "mfp-img-mobile", gallery: { enabled: !0, navigateByImgClick: !0, preload: [0, 1] }, image: { tError: '<a href="%url%">The image #%curr%</a> could not be loaded.', titleSrc: function(a) { return a.el.attr("title") } } }), $(".popup-youtube, .popup-vimeo, .popup-gmaps, .video-popup").magnificPopup({ disableOn: 700, type: "iframe", mainClass: "mfp-fade", removalDelay: 160, preloader: !1, fixedContentPos: !1 }) }

    function c() {
        $(".skillbar").appear(function() { $(".skillbar").each(function() { $(this).find(".skillbar-bar-child").animate({ width: $(this).attr("data-percent") }, 2e3) }) }), $(".counter-num").appear(function() {
            var a = $(this);
            a.countTo({ from: 0, to: a.html(), speed: 1300, refreshInterval: 60 })
            ...
            $(".tab-content").animate({ height: o }, function() { $(".tab-content").css("height", "auto") })
        });
