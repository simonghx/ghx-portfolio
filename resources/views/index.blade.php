    ...
    <div id="page-wraper">
        ...
        <header id="header" class="header header-light">
            <div class="header-inner">
                ...
                <div class="logo">
                    <a href="#">
                        <img class="logo-light" src="{{asset('theme/img/logo-light.png')}}" alt="Apollo" />
        ...
        <!-- Skills Section -->
        <section id="skills" class="section-padding pos-section gray-bg bg-image overlay-light" data-stellar-background-ratio="0.4" data-background-img="{{asset('theme/img/full/16.jpg')}}">
            <!-- page triangle shape -->
                ...
                <div class="rows">
                    ...
                    <div class="owl-carousel team-carousel nf-carousel-theme">
                        ...
                        <div class="item wow fadeInUp">
                            <div class="team-item">
                                <div class="team-item-img">
                                    <img src="{{asset('theme/img/team/01.jpg')}}" alt="" />
                        ...
                        <div class="item wow fadeInUp" data-wow-delay="0.1s">
                            <div class="team-item">
                                <div class="team-item-img">
                                    <img src="{{asset('theme/img/team/02.jpg')}}" alt="" />
                                    <div class="team-item-detail">
                                        <div class="team-item-detail-inner light-color">
                                            <ul class="social">
                                                <li><a href="https://www.facebook.com/" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="team-item">
                                <div class="team-item-img">
                                    <img src="{{asset('theme/img/team/03.jpg')}}" alt="" />
                                    <div class="team-item-detail">
                                        <div class="team-item-detail-inner light-color">
                                            <ul class="social">
                                                <li><a href="https://www.facebook.com/" target="_blank"><i class="fa fa-facebook"></i></a></li>
